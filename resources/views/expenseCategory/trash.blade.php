            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-defult">
                        ...
                        <a class="btn btn-sm bg-navy float-right text-capitalize" href="/expense/category/restoreAll"><i class="fa-solid fa-trash-arrow-up mr-2"></i>restore All</a>
                        <a class="btn btn-sm bg-maroon float-right text-capitalize mr-3" href="/expense/category/emptyTrash"><i class="fa-solid fa-trash-can mr-2"></i>Empty Trash</a>
                    </div>
