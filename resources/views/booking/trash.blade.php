            ...
            <div class="col-md-10 m-auto">
                ...
                <div class="card">
                    <div class="card-header bg-defult">
                        ...
                        <a class="btn btn-sm btn-success float-right text-capitalize mr-3" href="/booking/restoreAll"><i class="fa-solid fa-undo mr-2"></i>Restore All</a>
                    </div>
                                ...
                                @foreach ($Bookings as $Booking)
                                    <tr>
                                        ...
                                        <td class="">
                                            ...
                                            <a href="/Booking/{{ $Booking->id }}/restore" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Restore"><i class="fa-solid fa-undo ml-2 text-success"></i></a>
