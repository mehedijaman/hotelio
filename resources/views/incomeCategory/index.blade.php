...
@section('content')
    <div class="container col-md-12 ">
        <section class="button mb-4">
            <a href="{{ asset('incomeCategory/create') }}" class="btn btn-info text-capitalize">Add Category</a>
        </section>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                                        ...
                                        <td class="">
                                            ...
                                            <span class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li>
                                                        <a class="dropdown-item" href="/incomeCategory/{{ $Category->id }}/edit" style="letter-spacing:3px; font-family:'Courier New', Courier, monospace ;">
