...
@section('content')
    <div class="container col-md-12 ">
        <section class="button mb-4">
            <a href="{{ asset('income/create') }}" class="btn btn-info text-capitalize">Add Income Item</a>
        </section>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-info">
                        <div class="card-title">
                            <h2 class="card-title">Income Item List</h2>
                        </div>
                    </div>
                                        ...
                                        <td class="">
                                            ...
                                            <span class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li>
                                                        <a class="dropdown-item" href="/income/{{ $Income->id }}/edit" style="letter-spacing:3px; font-family:'Courier New', Courier, monospace ;">
